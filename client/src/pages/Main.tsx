  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/onboarding" element={!isAuthenticated?<Navigate to="/login"/>:onboarding?<Navigate to="/"/>:<Onboarding />} />
        

        <Route path={"/"} element={!isAuthenticated?<Navigate to={"/login"}/>:!onboarding?<Navigate to="/onboarding"/>:<UserMain/>}/>
